...
<html>
	...
	<h3 align=center>-*-*-*-*-*-*-　　글 쓰기　　-*-*-*-*-*-*-</h3>
		<form method=post action=gongjee_insertwrite.jsp enctype="multipart/form-data">
			...
			<tr>
				...
				<td><input style=width:500px type=text maxlength=100 required name=title required 
				placeholder="최대 100자까지만 입력가능합니다." ></td>
			</tr>	
			<tr>
			...
			<tr>
				...
				<td><textarea  name="content" id="summernote" value=""></textarea></td>
				<!-- html에디터 이용 -->
			</tr>
			<tr>
				<th width=50px bgcolor=#babaff>첨부파일</th>
				<td><input type=file name=file1 id="fileInp1"/>
				<br>
				<img id="blah" src="#" alt="your file1"/></td>
